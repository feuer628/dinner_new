...
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('vee-validate', factory) :
    ...
    var validate = function (value, ref) {
        ...
        return (alpha$1[locale] || alpha$1.ru).test(value);
    };
    ...
    var validate$1 = function (value, ref) {
        ...
        return (alphaDash[locale] || alphaDash.ru).test(value);
    };
    ...
    var validate$2 = function (value, ref) {
        ...
        return (alphanumeric[locale] || alphanumeric.ru).test(value);
    };
    ...
    var validate$3 = function (value, ref) {
        ...
        return (alphaSpaces[locale] || alphaSpaces.ru).test(value);
    };
    ...
    var messages = {
        after: function (field, ref) {
            ...
            return ("В поле " + field + " должна быть дата после " + target + ".");
        },
        ...
        alpha: function (field) { return ("Поле " + field + " может содержать только буквы."); },
        before: function (field, ref) {
            var target = ref[0];

            return ("В поле " + field + " должна быть дата до " + target + ".");
        },
        between: function (field, ref) {
            var min = ref[0];
            var max = ref[1];

            return ("Поле " + field + " должно быть между " + min + " и " + max + ".");
        },
        confirmed: function (field, ref) {
            var confirmedField = ref[0];

            return ("Поле " + field + " не совпадает с " + confirmedField + ".");
        },
        credit_card: function (field) { return ("Поле " + field + " должно быть действительным номером карты"); },
        ...
        date_format: function (field, ref) {
            ...
            return ("Поле " + field + " должно быть в формате " + format + ".");
        },
        ...
        ext: function (field, ref) {
            var args = ref.slice(0);

            return ("Поле " + field + " должно быть действительным файлом. (" + args + ")");
        },
        ...
        max_value: function (field, ref) {
            ...
            return ("Поле " + field + " должно быть " + max + " или менее.");
        },
        mimes: function (field, ref) {
            var args = ref.slice(0);

            return ("Поле " + field + " должно иметь действительный тип файла. (" + args + ")");
        },
        ...
        regex: function (field) { return ("Поле " + field + " имеет ошибочный формат."); },
        required: function (field) { return ("Поле " + field + " обязательно для заполнения."); },
        size: function (field, ref) {
            var size = ref[0];

            return ("Поле " + field + " должно быть меньше, чем " + (formatFileSize(size)) + ".");
        },
        url: function (field) { return ("Поле " + field + " имеет ошибочный формат URL."); }
    };
    var locale$1 = {
        name: 'ru',
        messages: messages,
    ...
    Dictionary.prototype._getDefaultMessage = function _getDefaultMessage (locale) {
        ...
        return this.container.ru.messages._default;
    };
    ...
    Validator.prototype.validate = function validate (name, value, scope) {
        ...
        var $args = arguments;
        return new Promise((function ($return, $error) {
            var matched, field, silentRun, result;
            if (this.paused)
            ...
            silentRun = field.isDisabled;
            return this._validate(field, value, silentRun).then((function ($await_3) {
                var this$1 = this;
    ...
    Validator.prototype.validateAll = function validateAll (values) {
        ...
        return new Promise((function ($return, $error) {
            ...
            promises = this.fields.filter(matcher).map(function (field) { return this$1.validate(("#" + (field.id)), providedValues ? values[field.name] : field.value); });
    ...
    Validator.prototype.validateScopes = function validateScopes () {
        return new Promise((function ($return, $error) {
            ...
            if (this.paused)
            { return $return(true); }
            promises = this.fields.map(function (field) { return this$1.validate(("#" + (field.id)), field.value); });
    ...
    var rulesPlugin = function (ref) {
        ...
        Validator.localize('ru', locale$1);
    };
